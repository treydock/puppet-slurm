shared_examples_for 'slurm::slurmd' do
  ...
  it { is_expected.to contain_class('slurm::slurmd::config').that_comes_before('Class[slurm::common::config]') }
  it { is_expected.to contain_class('slurm::common::config').that_comes_before('Class[slurm::slurmd::service]') }
